...
class Geohash {
  ...
  static String encodeFromPosition(
...
class LocationService {
  static const List<double> supportedRadii = [0.5, 1, 5, 10, 25, 50, 100];

  static const geolocator.LocationSettings preciseSettings =
      geolocator.LocationSettings(
        accuracy: geolocator.LocationAccuracy.medium,
        distanceFilter: 100,
      );

  static const geolocator.LocationSettings backgroundSettings =
      geolocator.LocationSettings(
