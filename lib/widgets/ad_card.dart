                ...
                children: [
                  ...
                  PopupMenuButton<String>(
                    ...
                    itemBuilder: (context) => [
                      const PopupMenuItem(
                        value: 'report',
                        child: Text('Report advertisement',
                            style: TextStyle(color: Colors.white)),
                      ),
                      const PopupMenuItem(
                        value: 'hide',
                        child: Text('Hide this advertisement',
                            style: TextStyle(color: Colors.white)),
                      ),
                      const PopupMenuItem(
                        value: 'dismiss',
  ...
  Future<void> _handleCta(BuildContext context) async {
    ...
    if (ad.clickAction == 'external_url' && ad.destinationUrl.isNotEmpty) {
      ...
      if (uri != null && (uri.scheme == 'https' || uri.scheme == 'http')) {
        // The actual launch will be done by url_launcher in the calling code
        // This widget only handles reporting the click
      }
    }
  }
}
