...
data class UserProfile(
    ...
    val voiceIntroText: String? = "Hey there! Looking forward to meeting someone genuine for coffee and weekend adventures.",
    val voiceDurationSec: Int = 14,
    val crossedPathLocation: String = "Koregaon Park & Blue Tokai Cafe",
    val riskLevel: String = "Low Risk · Verified"
)
